...
while CONTINUEGAME:
    ...
    SONGFILES = {
         ...
         2: ("TouchofGoldExtended.beatmap.txt", "TouchofGoldExtended.mp3", "Touch of Gold", 4.77),
         3: ("Handlebars.beatmap.txt", "Handlebars.mp3", "Handlebars", 3.44),
         4: ("Uprising.beatmap.txt", "Uprising.mp3", "Uprising", 5.05),
         5: ("GreatAmericanBitch.beatmap.txt", "GreatAmericanBitch.mp3", "Great American Bitch", 3.35),
         6: ("TheMarch.beatmap.txt", "TheMarch.mp3", "The March", 3.5),
         7: ("Heart.beatmap.txt", "Heart.mp3", "2022 - Heart of Tin", 9),
         8: ("Never.beatmap.txt", "Never.mp3", "2023 - Never Young", 9.72),
         9: ("from.beatmap.txt", "from.mp3", "2022.5 - From Darkness", 5.07),
